const STOCK_META = {
  ...
  'LG이노텍': { sector:'기타', desc:'기타', ticker:'011070' },
  ...
  '현대로템': { sector:'기타', desc:'기타', ticker:'064350' },
  'HD현대': { sector:'조선·에너지', desc:'조선·정유 지주', ticker:'267250' },
  'KT&G': { sector:'필수소비재', desc:'담배·건강기능식품', ticker:'033780' },
  '삼성에스디에스': { sector:'기타', desc:'기타', ticker:'018260' },
  '현대오토에버': { sector:'기타', desc:'기타', ticker:'307950' },
  ...
  'LS': { sector:'기타', desc:'기타', ticker:'006260' },
  ...
  '포스코인터내셔널': { sector:'기타', desc:'기타', ticker:'047050' },
  'LG씨엔에스': { sector:'기타', desc:'기타', ticker:'064400' },
  ...
  '삼성E&A': { sector:'기타', desc:'기타', ticker:'028050' },
  ...
  '한화': { sector:'기타', desc:'기타', ticker:'000880' },
  ...
  'GS': { sector:'기타', desc:'기타', ticker:'078930' },
  'LG디스플레이': { sector:'기타', desc:'기타', ticker:'034220' },
  ...
  '한화솔루션': { sector:'기타', desc:'기타', ticker:'009830' },
  ...
  '한국앤컴퍼니': { sector:'기타', desc:'기타', ticker:'000240' },
  ...
  '에스원': { sector:'기타', desc:'기타', ticker:'012750' },
  ...
  '이수스페셜티케미컬': { sector:'기타', desc:'기타', ticker:'457190' },
  ...
  '효성티앤씨': { sector:'기타', desc:'기타', ticker:'298020' },
  ...
  '디앤디파마텍': { sector:'기타', desc:'기타', ticker:'347850' },
  ...
  '우리기술': { sector:'기타', desc:'기타', ticker:'032820' },
  '테크윙': { sector:'기타', desc:'기타', ticker:'089030' },
  '실리콘투': { sector:'뷰티·화장품', desc:'화장품·뷰티', ticker:'257720' },
  '에스피지': { sector:'기타', desc:'기타', ticker:'058610' },
  ...
  '비에이치아이': { sector:'기타', desc:'기타', ticker:'083650' },
  ...
  '신성델타테크': { sector:'기타', desc:'기타', ticker:'065350' },
  ...
  '제이앤티씨': { sector:'기타', desc:'기타', ticker:'204270' },
  '필옵틱스': { sector:'기타', desc:'기타', ticker:'161580' },
  ...
  'CJ ENM': { sector:'기타', desc:'기타', ticker:'035760' },
  '씨아이에스': { sector:'기타', desc:'기타', ticker:'222080' },
  '동국제약': { sector:'바이오·제약·의료기기', desc:'헬스케어', ticker:'086450' },
  '쏠리드': { sector:'기타', desc:'기타', ticker:'050890' },
  ...
  '원텍': { sector:'기타', desc:'기타', ticker:'336570' },
  ...
  '젬백스': { sector:'기타', desc:'기타', ticker:'082270' },
  ...
  '동성화인텍': { sector:'기타', desc:'기타', ticker:'033500' },
  ...
  '인카금융서비스': { sector:'기타', desc:'기타', ticker:'211050' },
  '현대힘스': { sector:'기타', desc:'기타', ticker:'460930' },
  '천보': { sector:'2차전지·소재', desc:'배터리 밸류체인', ticker:'278280' },
  '아이쓰리시스템': { sector:'기타', desc:'기타', ticker:'214430' },
  '브이티': { sector:'뷰티·화장품', desc:'화장품·뷰티', ticker:'018290' },
  '아난티': { sector:'에너지·유틸리티·레저', desc:'에너지·레저', ticker:'025980' },
  '우리기술투자': { sector:'기타', desc:'기타', ticker:'041190' },
  '감성코퍼레이션': { sector:'기타', desc:'기타', ticker:'036620' },
  '한글과컴퓨터': { sector:'IT·소프트웨어', desc:'IT서비스·보안', ticker:'030520' },
  '시노펙스': { sector:'기타', desc:'기타', ticker:'025320' },
  '큐렉소': { sector:'로봇', desc:'로봇·자동화', ticker:'060280' },
  '펌텍코리아': { sector:'뷰티·화장품', desc:'화장품·뷰티', ticker:'251970' },
  '메가스터디교육': { sector:'기타', desc:'기타', ticker:'215200' },
  '네오위즈': { sector:'게임·엔터·IT', desc:'콘텐츠·플랫폼', ticker:'095660' },
  '동화기업': { sector:'기타', desc:'기타', ticker:'025900' },
  '제우스': { sector:'기타', desc:'기타', ticker:'079370' },
  ...
  '엠로': { sector:'기타', desc:'기타', ticker:'058970' },
...
async function selectStock(name) {
  ...
  document.getElementById('stockTicker').textContent = meta.ticker ? meta.ticker + '.KS' : '—';
...
const CODE_TO_NAME = {
  '005930':'삼성전자','000660':'SK하이닉스','005380':'현대차','373220':'LG에너지솔루션','012450':'한화에어로스페이스',
  '105560':'KB금융','035420':'NAVER','035720':'카카오','267250':'HD현대','034020':'두산에너빌리티',
  '207940':'삼성바이오로직스','068270':'셀트리온','005490':'POSCO홀딩스','000270':'기아','006400':'삼성SDI',
  '012330':'현대모비스','051910':'LG화학','096770':'SK이노베이션','028260':'삼성물산','034730':'SK',
  '086280':'현대글로비스','033780':'KT&G','017670':'SK텔레콤','055550':'신한지주','086790':'하나금융지주',
  '316140':'우리금융지주','138040':'메리츠금융지주','066570':'LG전자','009150':'삼성전기','402340':'SK스퀘어',
  '003550':'LG','015760':'한국전력','003670':'포스코퓨처엠','010130':'고려아연','329180':'HD현대중공업',
  '009540':'한국조선해양','010140':'삼성중공업','004020':'현대제철','272210':'한화시스템','323410':'카카오뱅크',
  '259960':'크래프톤','036570':'엔씨소프트','251270':'넷마블','377300':'카카오페이','030200':'KT',
  '010950':'S-Oil','011200':'HMM','097950':'CJ제일제당','090430':'아모레퍼시픽','051900':'LG생활건강',
  '042700':'한미반도체','352820':'하이브','032830':'삼성생명','000810':'삼성화재','005830':'DB손해보험',
  '024110':'기업은행','000720':'현대건설','006360':'GS건설','021240':'코웨이','139480':'이마트',
  '247540':'에코프로비엠','086520':'에코프로','196170':'알테오젠','141080':'리가켐바이오','028300':'HLB',
  '263750':'펄어비스','293490':'카카오게임즈','403870':'HPSP','277810':'레인보우로보틱스','214150':'클래시스',
  '214450':'파마리서치','357780':'솔브레인','058470':'리노공업','328130':'루닛'
};
